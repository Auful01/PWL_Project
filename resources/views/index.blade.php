                        ...
                        <li class="list-group-item list-group-item-action py-2">
                            <div class="row align-items-center">
                                ...
                                <div class="col-lg d-flex align-items-center text-md-right">
                                    ...
                                    <span class="avatar avatar-xs ml-2">
                                        <img src=" {{asset('images/avatar/demi.png')}}
                                            class="avatar-img rounded-circle" alt="">
                                    </span>
                                </div>
                            </div>
...
"datasets": [{"label": "Quotes", "data":[53,17,25,5]}]
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 py-2">
                        <div
                            ...
                            <a href=""><img
                                    ...
                                    src=" {{asset('images/posts/fabian-irsara-92113.jpg')}}"
                    ...
                    <div class="col-lg-6 py-2">
                        <div
                            ...
                            <a href=""><img
                                    class="img-fluid img-lg-150 img-xl-200 rounded mr-xl-3 mb-3 mb-xl-0"
                                    src=" {{asset('images/posts/luke-chesser-2347.jpg')}}"
                                    alt="Blog post image"></a>
                            <div class="flex">
                    ...
                    <div class="col-lg-6 py-2">
                        <div
                            ...
                            <a href=""><img
                                    class="img-fluid img-lg-150 img-xl-200 rounded mr-xl-3 mb-3 mb-xl-0"
                                    src=" {{asset('images/posts/thought-catalog-214785.jpg')}}"
                                    alt="Blog post image"></a>
                            <div class="flex">
                    ...
                    <div class="col-lg-6 py-2">
                        <div
                            ...
                            <a href=""><img
                                    class="img-fluid img-lg-150 img-xl-200 rounded mr-xl-3 mb-3 mb-xl-0"
                                    src=" {{asset('images/posts/linkedin-sales-navigator-402873.jpg')}}"
                                    alt="Blog post image"></a>
                            <div class="flex">
        ...
        <div class="card-deck card-margin">
            <div class="card">
                <img src=" {{asset('images/posts/thought-catalog-214785.jpg')}}" class="card-img-top" alt="">
                <div class="card-body">
                    <div class="d-flex align-items-center mb-3">
                        <div class="avatar avatar-sm mr-3">
                            <img src=" {{asset('images/avatars/andrew-robles-300868.jpg')}}"
                                class="avatar-img rounded-circle" alt="">
                        </div>
            ...
            <div class="card dashboard-chat">
                ...
                <div class="d-flex dashboard-chat__head">
                    <div class="avatar avatar-sm mr-3">
                        <img src=" {{asset('images/avatars/lucas-sankey-378674.jpg')}}"
                            class="avatar-img rounded-circle" alt="">
                    </div>
                    <div class="flex">
